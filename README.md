...
| `cloudflare.workerName` | Worker script identifier in Cloudflare dashboard.<br>Default: `lfs-server` | [`wrangler.jsonc` `name`](https://github.com/git-lfs-hub/server/blob/main/wrangler.template.jsonc#L7)<br>[`lfs.server`](vars.template.json#L8) |
